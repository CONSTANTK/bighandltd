...
<div class="body-inner">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    <ul class="top-info text-center text-md-left">
                        <li><i class="fas fa-map-marker-alt"></i> <p class="info-text">Big Hand Limited, Accra, Ghana</p>
                        </li>
                    </ul>
                </div>
                <!--/ Top info end -->
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a title="Facebook" href="{{asset('constra/https://facebbok.com/themefisher.com')}}">
                                <span class="social-icon"><i class="{{asset('constra/fab fa-facebook-f')}}"></i></span>
                            </a>
                            <a title="Twitter" href="{{asset('constra/https://twitter.com/themefisher.com')}}">
                                <span class="social-icon"><i class="{{asset('constra/fab fa-twitter')}}"></i></span>
                            </a>
                            <a title="Instagram" href="{{asset('constra/https://instagram.com/themefisher.com')}}">
                                <span class="social-icon"><i class="{{asset('constra/fab fa-instagram')}}"></i></span>
                            </a>
                            <a title="Linkdin" href="{{asset('constra/https://github.com/themefisher.com')}}">
                                <span class="social-icon"><i class="{{asset('constra/fab fa-github')}}"></i></span>
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="logo col-lg-3 text-center text-lg-left mb-3 mb-md-5 mb-lg-0">
                            <a class="d-block" href="{{asset('constra/index.html')}}">
                                <img loading="lazy" src="{{asset('constra/images/logo.png')}}" alt="{{asset('constra/Constra')}}">
                            </a>
                        </div><!-- logo end -->
                                ...
                                <li>
                                    <div class="info-box">
                                        <div class="info-box-content">
                                            ...
                                            <p class="info-box-subtitle">(+233) 24-387-7766</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="info-box">
                                        <div class="info-box-content">
                                            ...
                                            <p class="info-box-subtitle">thebighandent@yahoo.com</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="last">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-dark p-0">
                            ...
                            <div id="navbar-collapse" class="collapse navbar-collapse">
                                <ul class="nav navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="{{asset('constra/contact.html')}}">Contact</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
    ...
    <div class="banner-carousel banner-carousel-1 mb-0">
                ...
                <div class="container h-100">
                    <div class="row align-items-center h-100">
                        <div class="col-md-12 text-center">
                            <h2 class="slide-title" data-animation-in="slideInLeft">over 50 Years of excellence in</h2>
                            <h3 class="slide-sub-title" data-animation-in="slideInRight">Construction Industry</h3>
                            <p data-animation-in="slideInLeft" data-duration-in="1.2">
                                <a href="{{asset('constra/services.html')}}" class="slider btn btn-primary">Our Services</a>
                                <a href="{{asset('constra/contact.html')}}" class="slider btn btn-primary border">Contact Now</a>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="banner-carousel-item" style="{{asset('constra/background-image:url(images/slider-main/bg2.jpg)')}}">
                    ...
                    <div class="row align-items-center h-100">
                        <div class="col-md-12">
                            ...
                            <p data-animation-in="slideInRight">
                                <a href="{{asset('constra/services.html')}}" class="slider btn btn-primary border">Our Services</a>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="banner-carousel-item" style="{{asset('constra/background-image:url(images/slider-main/bg3.jpg)')}}">
                    ...
                    <div class="row align-items-center h-100">
                        <div class="col-md-12">
                            ...
                            <div data-animation-in="slideInLeft">
                                <a href="{{asset('constra/contact.html')}}" class="slider btn btn-primary" aria-label="contact-with-us">Get Free Quote</a>
                                <a href="{{asset('constra/about.html')}}" class="slider btn btn-primary border" aria-label="learn-more-about-us">Learn more</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="ts-service-box d-flex">
                        <div class="ts-service-box-img">
                            <img loading="lazy" src="{{asset('constra/images/icon-image/service-icon1.png')}}" alt="service-icon">
                        </div>
                    ...
                    <div class="ts-service-box d-flex">
                        <div class="ts-service-box-img">
                            <img loading="lazy" src="{{asset('constra/images/icon-image/service-icon3.png')}}"  alt="service-icon">
                        </div>
                        <div class="ts-service-box-info">
                ...
                <div class="col-lg-4 text-center">
                    <img loading="lazy" class="img-fluid" src="{{asset('constra/images/services/service-center.jpg')}}" alt="service-avater-image">
                </div><!-- Col end -->

                <div class="col-lg-4 mt-5 mt-lg-0 mb-4 mb-lg-0">
                    <div class="ts-service-box d-flex">
                        <div class="ts-service-box-img">
                            <img loading="lazy" src="{{asset('constra/images/icon-image/service-icon4.png')}}" alt="service-icon">
                        </div>
                        <div class="ts-service-box-info">
                    ...
                    <div class="ts-service-box d-flex">
                        <div class="ts-service-box-img">
                            <img loading="lazy" src="{{asset('constra/images/icon-image/service-icon5.png')}}" alt="service-icon">
                        </div>
                        <div class="ts-service-box-info">
                    ...
                    <div class="ts-service-box d-flex">
                        <div class="ts-service-box-img">
                            <img loading="lazy" src="{{asset('constra/images/icon-image/service-icon6.png')}}" alt="service-icon">
                        </div>
                        <div class="ts-service-box-info">
            ...
            <div class="row">
                                ...
                                <div class="project-item-info">
                                    <div class="project-item-info-content">
                                        <h3 class="project-item-title">
                                            <a href="{{asset('constra/projects-single.html')}}">Capital Teltway Building</a>
                                        </h3>
                        ...
                        <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;healthcare&quot;]">
                            <div class="project-img-container">
                                ...
                                <div class="project-item-info">
                                    <div class="project-item-info-content">
                                        <h3 class="project-item-title">
                                            <a href="{{asset('constra/projects-single.html')}}">Ghum Touch Hospital</a>
                                        </h3>
                        ...
                        <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;infrastructure&quot;,&quot;commercial&quot;]">
                            <div class="project-img-container">
                                <a class="gallery-popup" href="{{asset('constra/images/projects/project3.jpg')}}" aria-label="project-img">
                                    <img class="img-fluid" src="" alt="project-img">{{asset('constra/images/projects/project3.jpg')}}
                                    <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                </a>
                                <div class="project-item-info">
                                    <div class="project-item-info-content">
                                        <h3 class="project-item-title">
                                            <a href="{{asset('constra/projects-single.html')}}">TNT East Facility</a>
                                        </h3>
                        ...
                        <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;education&quot;,&quot;infrastructure&quot;]">
                            <div class="project-img-container">
                                ...
                                <div class="project-item-info">
                                    <div class="project-item-info-content">
                                        <h3 class="project-item-title">
                                            <a href="{{asset('constra/projects-single.html')}}">Narriot Headquarters</a>
                                        </h3>
                        ...
                        <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;infrastructure&quot;,&quot;education&quot;]">
                            <div class="project-img-container">
                                ...
                                <div class="project-item-info">
                                    <div class="project-item-info-content">
                                        <h3 class="project-item-title">
                                            <a href="{{asset('constra/projects-single.html')}}">Kalas Metrorail</a>
                                        </h3>
                                        <p class="project-cat">Infrastructure</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;residential&quot;]">
                            <div class="project-img-container">
                                ...
                                <div class="project-item-info">
                                    <div class="project-item-info-content">
                                        <h3 class="project-item-title">
                                            <a href="{{asset('constra/projects-single.html')}}">Ancraft Avenue House</a>
                                        </h3>
                ...
                <div class="col-12">
                    <div class="general-btn text-center">
                        <a class="btn btn-primary" href="{{asset('constra/projects.html')}}">View All Projects</a>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <span class="quote-text">
                      ...
                      subline of her own road.
                                ...
                                <div class="quote-item-footer">
                                    <img loading="lazy" class="testimonial-thumb" src="{{asset('constra/images/clients/testimonial1.png')}}" alt="testimonial">
                    ...
                    <span class="quote-text">
                      ...
                      nisi aliquip consequat.
                                ...
                                <div class="quote-item-footer">
                                    <img loading="lazy" class="testimonial-thumb" src="{{asset('constra/images/clients/testimonial2.png')}}" alt="testimonial">
                                    <div class="quote-item-info">
                    ...
                    <span class="quote-text">
                      ...
                      nisi ut commodo consequat.
                                ...
                                <div class="quote-item-footer">
                                    <img loading="lazy" class="testimonial-thumb" src="{{asset('constra/images/clients/testimonial3.png')}}" alt="testimonial">
                                    <div class="quote-item-info">
                    ...
                    <div class="row all-clients">
                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid" src="{{asset('constra/images/clients/client1.png')}}" alt="clients-logo" /></a>
                            </figure>
                        </div><!-- Client 1 end -->

                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid" src="{{asset('constra/images/clients/client2.png')}}" alt="clients-logo" /></a>
                            </figure>
                        </div><!-- Client 2 end -->

                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid" src="{{asset('constra/images/clients/client3.png')}}" alt="clients-logo" /></a>
                            </figure>
                        </div><!-- Client 3 end -->

                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid" src="{{asset('constra/images/clients/client4.png')}}" alt="clients-logo" /></a>
                            </figure>
                        </div><!-- Client 4 end -->

                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid" src="{{asset('constra/images/clients/client5.png')}}" alt="clients-logo" /></a>
                            </figure>
                        </div><!-- Client 5 end -->

                        <div class="col-sm-4 col-6">
                            <figure class="clients-logo">
                                <a href="#!"><img loading="lazy" class="img-fluid" src="{{asset('constra/images/clients/client6.png')}}" alt="clients-logo" /></a>
                            </figure>
                        </div><!-- Client 6 end -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="latest-post">
                        <div class="latest-post-media">
                            <a href="{{asset('cponstra/news-single.html')}}" class="latest-post-img">
                                <img loading="lazy" class="img-fluid" src="{{asset('constra/images/news/news1.jpg')}}" alt="img">
                            </a>
                        </div>
                        <div class="post-body">
                            <h4 class="post-title">
                                <a href="{{asset('constra/news-single.html')}}" class="d-inline-block">We Just Completes $17.6 million Medical Clinic in Mid-Missouri</a>
                            </h4>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="latest-post">
                        <div class="latest-post-media">
                            <a href="{{asset('constra/news-single.html')}}" class="latest-post-img">
                                <img loading="lazy" class="img-fluid" src="{{asset('constra/images/news/news2.jpg')}}" alt="img">
                            </a>
                        </div>
                        <div class="post-body">
                            <h4 class="post-title">
                                <a href="{{asset('constra/news-single.html')}}" class="d-inline-block">Thandler Airport Water Reclamation Facility Expansion Project Named</a>
                            </h4>
                            <div class="latest-post-meta">
                    <span class="post-item-date">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="latest-post">
                        <div class="latest-post-media">
                            <a href="{{asset('constra/news-single.html')}}" class="latest-post-img">
                                <img loading="lazy" class="img-fluid" src="{{asset('constra/images/news/news3.jpg')}}" alt="img">
                            </a>
                        </div>
                        <div class="post-body">
                            <h4 class="post-title">
                                <a href="{{asset('constra/news-single.html')}}" class="d-inline-block">Silicon Bench and Cornike Begin Construction Solar Facilities</a>
                            </h4>
                            <div class="latest-post-meta">
                    <span class="post-item-date">
            ...
            <div class="general-btn text-center mt-4">
                <a class="btn btn-primary" href="{{asset('constra/news-left-sidebar.htm')}}l">See All Posts</a>
            </div>
