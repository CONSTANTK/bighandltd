...
<div class="body-inner">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light p-0">
                            ...
                            <div class="logo">
                                <a class="d-block" href="{{asset('constra/index-2.html')}}">
                                ...
                                <ul class="nav navbar-nav ml-auto align-items-center">
                                    <li class="nav-item dropdown active">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="{{asset('front.welcome')}}">Home One</a></li>
                                            <li class="active"><a href="{{route('front.home2')}}">Home Two</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="header-get-a-quote">
                                        <a class="btn btn-primary" href="{{asset('constra/contact.html')}}">Get Free Quote</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
    ...
    <div class="banner-carousel banner-carousel-2 mb-0">
            ...
            <div class="container">
                <div class="box-slider-content">
                    <div class="box-slider-text">
                        ...
                        <p>
                            <a href="{{asset('constra/services.html')}}" class="slider btn btn-primary">Our Service</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="banner-carousel-item" style="{{asset('constra/background-image:url(images/slider-main/bg5.jpg)')}}">
                ...
                <div class="container">
                    <div class="box-slider-content">
                        <div class="box-slider-text">
                            ...
                            <p class="box-slide-description">You have ideas, goals, and dreams. We have a culturally diverse, forward
                                thinking team looking for talent like.</p>
                            <p><a href="{{asset('constra/about.html')}}" class="slider btn btn-primary" aria-label="about-us">Know Us</a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-center text-md-right mt-3 mt-md-0">
                        <div class="call-to-action-btn">
                            <a class="btn btn-primary" href="{{route('front.contact')}}">Request Quote</a>
                        </div>
                    </div><!-- col end -->
                </div><!-- row end -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-5">
                    <div class="ts-service-box">
                        <div class="ts-service-image-wrapper">
                            <img loading="lazy" class="w-100" src="{{asset('constra/images/services/service1.jpg')}}" alt="service-image">
                        </div>
                        <div class="d-flex">
                            ...
                            <div class="ts-service-info">
                                <h3 class="service-box-title"><a href="{{asset('constra/service-single.html')}}">Zero Harm Everyday</a></h3>
                                ...
                                <a class="learn-more d-inline-block" href="{{asset('constra/service-single.html')}}" aria-label="service-details"><i class="fa fa-caret-right"></i> Learn more</a>
                            </div>
                        </div>
                    </div><!-- Service1 end -->
                </div><!-- Col 1 end -->
                ...
                <div class="col-lg-4 col-md-6 mb-5">
                    <div class="ts-service-box">
                        <div class="ts-service-image-wrapper">
                            <img loading="lazy" class="w-100" src="{{asset('constra/images/services/service2.jpg')}}" alt="service-image">
                        </div>
                        <div class="d-flex">
                            <div class="ts-service-box-img">
                            ...
                            <div class="ts-service-info">
                                <h3 class="service-box-title"><a href="{{asset('constra/service-single.html')}}">Virtual Construction</a></h3>
                                <p>You have ideas, goals, and dreams. We have a culturally diverse, forward thinking team looking for talent like. Lorem ipsum dolor suscipit.</p>
                                <a class="learn-more d-inline-block" href="{{asset('constra/service-single.html')}}" aria-label="service-details"><i class="fa fa-caret-right"></i> Learn more</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-5">
                    <div class="ts-service-box">
                        <div class="ts-service-image-wrapper">
                            <img loading="lazy" class="w-100" src="{{asset('constra/images/services/service3.jpg')}}" alt="service-image">
                        </div>
                        <div class="d-flex">
                            <div class="ts-service-box-img">
                            ...
                            <div class="ts-service-info">
                                <h3 class="service-box-title"><a href="{{asset('constra/service-single.html')}}">Build To Last</a></h3>
                                <p>You have ideas, goals, and dreams. We have a culturally diverse, forward thinking team looking for talent like. Lorem ipsum dolor suscipit.</p>
                                <a class="learn-more d-inline-block" href="{{asset('constra/service-single.html')}}" aria-label="service-details"><i class="fa fa-caret-right"></i> Learn more</a>
                            </div>
                        </div>
    ...
    <section id="news" class="news">
        <div class="container">
            ...
            <div class="general-btn text-center mt-4">
                <a class="btn btn-primary" href="{{asset('constra/news-left-sidebar.html')}}">See All Posts</a>
            </div>
