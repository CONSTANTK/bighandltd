...
<div class="body-inner">
                    ...
                    <div class="row align-items-center">
                        <div class="logo col-lg-3 text-center text-lg-left mb-3 mb-md-5 mb-lg-0">
                            <a class="d-block" href="{{asset('constra/index.html')}}">
                                <img loading="lazy" src="{{asset('constra/images/cmm.jpeg')}}" alt="cmm.jpeg">
                            </a>
                        </div><!-- logo end -->
                                ...
                                <ul class="nav navbar-nav mr-auto">
                                    <li class="nav-item dropdown active">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li class="active"><a href="{{asset('constra/index.html')}}">Home One</a></li>
    ...
    <div class="banner-carousel banner-carousel-1 mb-0">
        <div class="banner-carousel-item" style="{{asset('constra/background-image:url(images/slider-main/bg1.jpg)')}}">
